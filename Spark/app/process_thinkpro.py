...
df = spark.read.option("delimiter", ",") \
      ...
      .option("header", True) \
      .schema(schema) \
      .load("../spark/resources/data/laptops-thinkpro.csv")
...
df = df.select(col("Name"), col("Price"), col("URL"),col("CPU"),col("Ram"),col("Storage"),col("Graphics"),col("Display"),col("Battery"),\
...
df = df.withColumn("Price", translate("Price", ".đ", "")) \
      ...
      .withColumn("Display", regexp_replace("Display", "inches", " inch")) \
